...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#171717] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white dark:bg-[#111] p-8 md:p-12 rounded-3xl shadow-sm border border-black/5 dark:border-white/5">
        <h1 className="text-4xl font-black mb-8 text-[#171717] dark:text-white" style={{ fontFamily: 'Georgia, serif' }}>
          Privacy Policy
        </h1>
        <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 space-y-6">
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">1. Information We Collect</h2>
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">3. Information Sharing</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">4. Data Security</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">5. Contact Us</h2>
          <p>
