    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#171717] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white dark:bg-[#111] p-8 md:p-12 rounded-3xl shadow-sm border border-black/5 dark:border-white/5">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 space-y-6">
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">1. Acceptance of Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">2. Investment Risks</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">3. User Accounts</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">5. Platform Fees</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#171717] dark:text-white mt-8 mb-4">6. Limitation of Liability</h2>
          <p>
