...
export default function About() {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative px-4 sm:px-6 lg:px-10 pt-40 pb-20 overflow-hidden bg-gradient-to-b from-[#FAF8F5] to-white">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl text-[#0A0A0A]/60 max-w-3xl mx-auto leading-relaxed"
          >
      ...
      <section className="px-4 sm:px-6 lg:px-10 py-24 bg-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 text-lg text-[#0A0A0A]/70 leading-relaxed">
              <p>
      ...
      {/* 3. Mission & Vision */}
      <section className="px-4 sm:px-6 lg:px-10 py-32 bg-[#0A0A0A] text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 relative z-10">
          <div className="bg-white/5 border border-white/10 rounded-[2rem] p-10 md:p-14 hover:bg-white/10 transition-colors">
            ...
            <h3 className="text-3xl text-white mb-6" style={{ fontFamily: 'Georgia, serif' }}>Our Mission</h3>
          ...
          <div className="bg-white/5 border border-white/10 rounded-[2rem] p-10 md:p-14 hover:bg-white/10 transition-colors">
            ...
            <h3 className="text-3xl text-white mb-6" style={{ fontFamily: 'Georgia, serif' }}>Our Vision</h3>
            <p className="text-lg text-white/70 leading-relaxed">
      ...
      <section className="px-4 sm:px-6 lg:px-10 py-32 bg-[#FAF8F5]">
        <div className="max-w-7xl mx-auto text-center mb-20">
          <h2 className="text-4xl md:text-5xl text-[#0A0A0A] mb-6" style={{ fontFamily: 'Georgia, serif' }}>
            What drives us
          </h2>
        ...
        <div className="max-w-7xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={idx} className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-black/[0.03] hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-[#0A0A0A]/60 leading-relaxed text-sm">{value.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* 5. Closing CTA */}
      <section className="px-4 sm:px-6 lg:px-10 py-32 bg-white text-center">
        <div className="max-w-3xl mx-auto bg-[#F7D0BC]/20 p-12 md:p-20 rounded-[3rem] border border-[#F7D0BC]/50">
          ...
          <p className="text-lg text-[#0A0A0A]/70 mb-10 max-w-xl mx-auto">
            Join thousands of smart investors who are building their portfolios with Terrashare today.
          </p>
          <Link 
            to="/signup"
            className="inline-flex h-14 items-center justify-center rounded-full bg-[#0A0A0A] px-10 text-sm font-bold text-white transition-transform hover:scale-105 shadow-xl shadow-black/10 gap-2"
          >
